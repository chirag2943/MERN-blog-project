    ...
    <div className="group relative w-[360px] border border-teal-700 hover:border-2 h-[310px] overflow-hidden rounded-lg  transition-all">
      ...
      <div className="p-3 flex flex-col gap-2  ">
        ...
        <Link
          ...
          className="z-10 group-hover:bottom-0 absolute bottom-[-200px] left-0 right-0 border bg-teal-500
           border-teal-500 hover:text-black text-white transition-all duration-300 text-center py-2 rounded-md !rounded-tl-none m-2"
        >
          Read about project
        </Link>
      </div>
